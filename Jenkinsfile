pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'INKSCAPE_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-inkscape'
    CONTAINER_NAME = 'inkscape'
    DOCKERHUB_IMAGE = 'linuxserver/inkscape'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-inkscape/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-inkscape\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-inkscape\" \
          ...
          --label \"org.opencontainers.image.description=[Inkscape](https://inkscape.org/) is professional quality vector graphics software which runs on Linux, Mac OS X and Windows desktop computers.\" \
